...
class dbc(object):
  def __init__(self, fn):
    ...
    print __file__ + "__init__"
    print "fn=" + fn 
    print "basename=" + os.path.basename(fn) 
...
#	print "BO_" + "name=" + dat.group(2) + "size=" + int(dat.group(3)) + "ids=" + int(dat.group(1), 0)

        print ("BO_  name=%s size=%d ids=%d " % (dat.group(2),int(dat.group(3)),int(dat.group(1), 0)) )
    ...
    print "@@@lookup_msg_id"
    print self.lookup_msg_id("STEER_ANGLE_SENSOR")
...
if __name__ == "__main__":
   ...
   print "test !!"
   dbc_test = dbc(os.path.join(DBC_PATH, 'toyota_prius_2017_pt_generated-2.dbc'))
